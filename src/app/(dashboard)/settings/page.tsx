...
//                         </div>
//                     </div>
//                     <div className="bg-[#FFFFFF0D] py-3 text-center">
...
//                             <div
//                                 key={post.id}
//                                 style={{ backgroundColor: post.bg }} // <-- dynamic background fix
//                                 className={`rounded-xl border p-6 relative transition-all hover:bg-[#222] ${post.status === 'win' ? 'border-[#10b981]/30' : 'border-[#ef4444]/30'
//                                     }`}
//                             >
//                                 {/* Status Icon */}
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="space-y-1 md:space-y-2">
                  <span className="text-[9px] sm:text-[10px] font-bold bg-[#f59e0b]/20 text-[#f59e0b] px-1.5 py-0.5 rounded uppercase">
                    {post.sport}
                  </span>
                ...
                {/* Footer Info */}
                <div className="mt-4 md:mt-6 pt-2 md:pt-4 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center text-xs md:text-xs font-semibold text-gray-500 gap-1 sm:gap-0">
                  <p>Odds: <span className="text-white">{post.odds}</span></p>
                  <p>{post.time}</p>
                </div>
              </div>
