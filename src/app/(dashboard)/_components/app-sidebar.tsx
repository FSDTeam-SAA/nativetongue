    ...
    <Sidebar className="flex flex-col justify-between h-full">
      <SidebarContent className="bg-black text-white flex flex-col justify-between">
                  ...
                  return (
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton asChild>
                        <Link
                          href={item.url}
                          className={`h-[45px] flex items-center gap-2 px-4 font-bold ${isActive
                            ? "bg-gradient-to-r from-[#329150] to-[#0d4728] hover:bg-gradient-to-r hover:from-[#0d4728] hover:to-[#329150]"
                            : "hover:bg-gradient-to-r hover:from-[#329150] hover:to-[#0d4728]"
                            }`}
                        >
                          <item.icon />
                          <span>{item.title}</span>
        ...
        <div className="mb-8 px-4 flex flex-col items-start gap-3">
          ...
          {/* Logout Button */}
          <button onClick={()=>signOut({callbackUrl:"/login"})} className="w-full flex items-center gap-2 text-[#E53838] border border-[#E53838] px-4 py-2 rounded-lg hover:bg-[#E53838]/60 hover:text-white transition">
            <LogOut size={18} />
            Log out
          </button>
        </div>
