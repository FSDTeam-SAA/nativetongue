...
// const Leaderboard = () => {
//     return (
//         <div className="min-h-screen bg-[#0f0f0f] text-white p-2 md:p-2 font-sans">
//             {/* Header Section */}
//             <header className="mb-8">
//                 <h1 className="text-4xl font-bold mb-2">Leaderboard</h1>
//                 <p className="text-gray-400 text-lg">Follow the sharpest bettors</p>
//             </header>
...
//                     Top ROI
//                 </button>
//                 <button className="px-5 py-2 rounded-full border border-gray-700 bg-transparent text-gray-300 font-medium text-sm whitespace-nowrap hover:bg-gray-800 transition">
//                     Hottest
//                 </button>
//                 <button className="px-5 py-2 rounded-full border border-gray-700 bg-transparent text-gray-300 font-medium text-sm whitespace-nowrap hover:bg-gray-800 transition">
//                     All Sports
...
//                     <div
//                         key={idx}
//                         className="bg-[#1a1a1a] rounded-2xl p-6 flex justify-between items-center border border-transparent hover:border-gray-800 transition shadow-xl"
//                     >
...
//                                 />
//                                 <h3 className="text-xl font-bold mb-1">{bettor.name}</h3>
//                             </div>

//                             {/* Info */}
//                             <div>
//                                 <p className="text-sm text-gray-400 mb-2">
//                                     profit · <span className="text-[#22c55e] font-semibold">{bettor.profit}</span>
//                                 </p>

//                                 <div className="flex flex-col gap-2">
//                                     <span className="text-[10px] uppercase tracking-wider text-gray-500 font-bold">Strengths</span>
//                                     <div className="flex gap-2">
//                                         {bettor.strengths.map((sport) => (
//                                             <span key={sport} className="px-3 py-1 border-[#2A2A2A] border rounded-full text-xs text-gray-300">
//                                                 {sport}
//                                             </span>
//                                         ))}
//                                     </div>
...
//                         {/* Action Button */}
//                         <button className="bg-[#3b82f6] hover:bg-[#2563eb] text-white px-8 py-2 rounded-full font-semibold text-sm transition self-start md:self-center">
//                             Follow
//                         </button>
//                     </div>
//                 ))}
